...
const Itinerary = () => {
  ...
  return (
    <div className="w-full h-full mt-3 flex justify-end pr-10">
      <section className="w-[70%] bg-gray-900 text-white rounded-2xl shadow-xl overflow-hidden">
        <div className="min-h-screen w-full px-6 py-10 flex flex-col items-center gap-10 bg-gray-800">
          {/* Header Image */}
          ...
          {/* Destination */}
          <h2 className="text-4xl font-extrabold text-white">{myTrip.destination}</h2>

          {/* Weather Forecast */}
          <section className="w-full max-w-3xl bg-white text-gray-800 rounded-xl shadow-md p-6">
            <h3 className="text-xl font-semibold mb-4 flex items-center gap-2"><Sun className="text-yellow-500" /> Weather Forecast</h3>
          ...
          <section className="w-full max-w-3xl bg-white text-gray-800 rounded-xl shadow-md p-6 space-y-4">
            ...
            {/* Flights */}
            <div>
              <h4 className="font-medium flex items-center gap-2"><Plane className="text-blue-500" size={18} /> Flights</h4>
            ...
            {/* Trains */}
            <div>
              <h4 className="font-medium flex items-center gap-2 mt-3"><TrainFront className="text-green-500" size={18} /> Trains</h4>
          ...
          <section className="w-full max-w-4xl flex flex-col items-center gap-5">
            <h3 className="text-2xl font-semibold text-white flex items-center gap-2"><CalendarDays /> Trip Plan</h3>
          ...
          <section className="w-full max-w-4xl bg-white text-gray-800 rounded-xl shadow-md p-6">
            <h3 className="text-xl font-semibold mb-4 flex items-center gap-2"><Hotel className="text-purple-500" /> Recommended Hotels</h3>
          ...
          {/* <div className="w-full max-w-4xl">
            <MapComponent places={myTrip.placesToVisit} type="places" />
          </div> */}
        </div>
      </section>
    </div>
